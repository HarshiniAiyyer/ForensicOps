...
st.markdown(
    """
    **Benford's Law** states that in naturally occurring numerical datasets, the
    **leading digit is more likely to be small (1 appears more often than 9).**
...
github_url = st.text_input(
    "Enter GitHub CSV URL:",
    "https://raw.githubusercontent.com/HarshiniAiyyer/Financial-Forensics/refs/heads/main/data/states.csv",
)
...
if "data" in st.session_state:
    ...
    if numeric_columns:
        benford_column = st.selectbox(
            "Select a column for Benford's Law analysis:", numeric_columns
        )
        ...
        if st.button("Run Benford's Law Analysis"):
            ...
            tab1, tab2, tab3, tab4 = st.tabs(
                ["First Digit", "Second Digit", "Last Digit", "Second Last Digit"]
            )
...
if "data" in st.session_state:
    ...
    # UPDATED INDEX-BASED SELECTION
    feature_indices = [5, 6, 7, 8, 10, 11, 12, 13]
    target_index = 9
